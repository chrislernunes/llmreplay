...
@click.argument("run_id")
@click.option("--dir", "base_dir", default=None, help="Override storage directory")
def web_ui(run_id, base_dir):
    """Launch the Streamlit web timeline UI for a run."""
    from llmreplay.web import launch
    launch(run_id, Path(base_dir) if base_dir else None)
